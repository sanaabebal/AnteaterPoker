...
/* Structures and relevant Vectors */
    ...
    struct GameState{
        ...
        int greatest{0}; // holds the last active player who must answer before the betting round closes. // CODEX FIX: document the turn-loop meaning used by gamestate.cpp.
