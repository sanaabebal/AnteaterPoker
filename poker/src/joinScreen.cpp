...
int main(int argc, char* argv[]) {
    ...
    vector<PLAYER> mockPlayers;
    PLAYER Alice; PLAYER Bob;
    strcpy(Alice.name, "Alice"); strcpy(Bob.name, "Bob");
    Alice.playerNum = 1; Bob.playerNum = 2;
    mockPlayers.push_back(Alice); mockPlayers.push_back(Bob);
